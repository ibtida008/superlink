        ...
        <div id="wrapper">
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <hr>
                    <router-link to="/allUsers" tag="li">
                        <p>
                            <a class="nav-items">All Users</a>
                        </p>      
                    </router-link>
                    <router-link to="/requestList" tag="li">
                        <p>
                            <a class="nav-items">Requests</a>
                        </p>      
                    </router-link>
                    <router-link to="/manageWebsites" tag="li">
                        <p>
                            <a class="nav-items">Manage Websites</a>
                        </p>      
                    </router-link>
                </ul>
            </div>
